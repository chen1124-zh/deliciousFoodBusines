			...
			<view class="good_left">
				...
				<view class="good_title_select">
					<view :class="classifSelect==index?'selectGood':''" v-for="(item,index) in classifiList" :key='index' @click="classClick(index)">
						<text style="color: #999;">{{item.menuName}}</text>
					</view>
	...
	export default {
		data() {
			return {
				...
				classifiList:[
					{
						createTime: 1629872784000,
						id: "CA5D545BCCA4E58EE0531D02A8C0D865",
						menuName: "特色菜系",
						menuSort: 1,
						storeId: "41",
						type: 0,
						updateTime: 1629883250000,
					},
					{
						createTime: 1629872784000,
						id: "CA5D545BCCA4E58EE0531D02A8C0D865",
				...
				goodList:[
					{
						createTime: 1629876240000,
						describe: "采用精装的食材，经小火慢炖12小时",
						discount: 0,
						energy: "1",
						id: "CA5E18085EF06E55E0531D02A8C05798",
						linedPrice: 1,
						makeTime: 1,
						img:'../../static/tempgood3.png',
						menuType: "CA5D545BCCA6E58EE0531D02A8C0D865",
						packing: "1",
						producingArea: "1",
						productImg: "../../static/tempgood3.png",
						productName: "麻辣香锅",
						productPrice: 4.5,
						productStatus: "1",
						productWeight: 1,
						saleMoney: 0,
						saleNum: 0,
						specification: "[{'name':'测试商品1','price':'1'},{'name':'测试商品2','price':'1'},{'name':'测试商品3','price':'1'}]",
						ssProduct: "CA4FE44E96A4538EE0531D02A8C0138E",
						stock: "1",
						storeId: "41",
						storeName: "测试店铺",
						updateTime: 1629877789000,
						wc: 1,
						wcn: 1,
						week1: 1,
						week2: 1,
